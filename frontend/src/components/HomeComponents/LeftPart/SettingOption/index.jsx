    ...
    <div className="bg-white w-[300px] shadow-md rounded-md p-4">
      <ul>
        <li className="flex items-center gap-x-2 group cursor-pointer mb-5" onClick={()=>setVisible(true)}>
          ...
          <div>
            <p className="font-noto font-bold text-base text-black group-hover:text-secondary_color transition-all ease-linear duration-75">
        ...
        <li className="flex items-center gap-x-2 group cursor-pointer">
          ...
          <div>
            <p className="font-noto font-bold text-base text-black group-hover:text-secondary_color transition-all ease-linear duration-75">Logout</p>
          </div>
        </li>
      </ul>
    </div>
